...
gflags.DEFINE_string('index_load_path', '', 'Path to store model checkpoint')
gflags.DEFINE_string('index_export_label', '', 'Path to store model checkpoint')
...
def main(argv):
    ...
    controller.evaluate_indices_from_file(FLAGS.index_load_path, FLAGS.index_export_label)
