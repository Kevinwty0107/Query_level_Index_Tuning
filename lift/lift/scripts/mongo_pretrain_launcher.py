...
from lift.case_studies.mongodb.mongo_pretrain_controller import MongoPretrainController
...
gflags.DEFINE_boolean('fixed_workload', True, 'If true, use fid workload')
...
def main(argv):
    ...
    controller = MongoPretrainController(
