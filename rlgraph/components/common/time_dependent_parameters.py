...
class TimeDependentParameter(Component):
    ...
    def __init__(self, from_=None, to_=None, max_time_steps=None, resolution=1000, scope="parameter", **kwargs):
        ...
        kwargs_start_time_step = kwargs.pop("start_timestep", None)
        kwargs_max_time_steps = kwargs.pop("num_timesteps", None)
        ...
        self.max_time_steps = kwargs_max_time_steps if kwargs_max_time_steps is not None else max_time_steps if max_time_steps is not None else 2000
