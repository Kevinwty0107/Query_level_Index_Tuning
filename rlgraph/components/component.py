...
class Component(Specifiable):
    ...
    def get_variable(self, name="", shape=None, dtype="float", initializer=None, trainable=True,
        ...
        # Direct variable creation (using the backend).
            ...
            if initializer is None or isinstance(initializer, tf.initializers.truncated_normal) or isinstance(initializer, tf.zeros_initializer) or isinstance(initializer, tf.constant_initializer):
