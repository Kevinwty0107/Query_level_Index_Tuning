...
from imdb_common.postgres_data_source import PostgresDataSource
from imdb_common.postgres_system_environment import PostgresSystemEnvironment

from imdb_common.imdb_util import imdb_table_columns
...
class PostgresTuner():
    ...
    def __init__(self, train_queries, test_queries, experiment_config, result_dir, system_environment):
        ...
        for tbl in self.tbls:
            ...
            for col_idx, col in enumerate(imdb_table_columns[tbl].keys()):
    ...
    def build_search_space(self):
        ...
        *updated* search space
        ...
        for tbl in self.tbls:
            n_cols_per_tbl = len(imdb_table_columns[tbl])
    ...
    def run(self, n_iterations):
        ...
        for i in range(n_iterations):
            ...
            self.logger.info('...best config: {}'.format(best))
