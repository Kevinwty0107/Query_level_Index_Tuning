...
from imdb_common.imdb_util import imdb_tables, imdb_table_columns
...
imdb_DSN = "dbname=imdbload user=wangtaiyi"
...
class PostgresSystemEnvironment(SystemEnvironment):
    ...
    def __init__(self, tbls):
        ...
        try: 
            self.imdb_cxn = self.__connect(imdb_DSN)
    ...
    def act(self, action):
        ...
        if index in self.index_set:
            ...
            with self.imdb_cxn.cursor() as curs:
                try:
    ...
    def reset(self):
        ...
        for tbl in imdb_tables: # TODO self.tbls would suffice
    ...
    def compute_column_selectivity(self):
        ...
        with self.imdb_cxn.cursor() as curs:
            for tbl in self.tbls: 
                ...
                for col in imdb_table_columns[tbl].keys():
